...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aigor-v1
```

A live public deployment of this template is available at [https://aigor-v1.templates.workers.dev](https://aigor-v1.templates.workers.dev)
